...
class Seq2Seq(nn.Module):
    """
        ...
        * `predict_lines` - whether to predict lines. if false, it will generate single tokens
    """
    def __init__(self, encoder,decoder,config,beam_size=None,max_length=None,sos_id=None,eos_id=None,predict_lines=True):
        ...
        self.sos_id=sos_id
        self.eos_id=eos_id
        self.predict_lines=predict_lines
